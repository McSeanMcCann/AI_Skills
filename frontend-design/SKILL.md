...
NEVER use generic AI aesthetics: overused fonts (Inter, Roboto, Arial), cliched color schemes (purple gradients on white), predictable layouts, or cookie-cutter components.
